...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function zl(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:So(),fragmentShader:`
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function Vl(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:So(),fragmentShader:`
...
`)}function Kg(r,t){let e;switch(t){case xh:e="Linear";break;case yh:e="Reinhard";break;case Mh:e="Cineon";break;case Sh:e="ACESFilmic";break;case Th:e="AgX";break;case bh:e="Neutral";break;case Eh:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Zr=new R;function $g(){Gt.getLuminanceCoefficients(Zr);const r=Zr.x.toFixed(4),t=Zr.y.toFixed(4),e=Zr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function a_(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===rc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===jc?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===mn&&(t="SHADOWMAP_TYPE_VSM"),t}function o_(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ei:case Ti:t="ENVMAP_TYPE_CUBE";break;case cs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function l_(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ti:t="ENVMAP_MODE_REFRACTION";break}return t}function c_(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Qa:t="ENVMAP_BLENDING_MULTIPLY";break;case _h:t="ENVMAP_BLENDING_MIX";break;case vh:t="ENVMAP_BLENDING_ADD";break}return t}function h_(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function u_(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=a_(e),l=o_(e),h=l_(e),u=c_(e),d=h_(e),p=jg(e),g=Qg(s),v=i.createProgram();let m,f,b=e.glslVersion?"#version "+e.glslVersion+`
