 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye=1e3,Xe=2,qe=14400*1e3,Qe=.5;function Fn(t,e=Ye,n=Xe){const r=e*Math.pow(n,t),s=Math.round(Qe*r*(Math.random()-.5)*2);return Math.min(qe,r+s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Et{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ct(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Ct(t){return t.getComponent()?.type==="VERSION"}const M="@firebase/app",V="0.14.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fn(t){U(new T("platform-logger",e=>new Et(e),"PRIVATE")),U(new T("heartbeat",e=>new cn(e),"PRIVATE")),A(M,V,t),A(M,V,"esm2020"),A("fire-js","")}fn("");export{et as $,Ln as A,Rn as B,T as C,Pe as D,me as E,D as F,ue as G,H,He as I,gn as J,_n as K,ot as L,mn as M,$e as N,wn as O,Tn as P,B as Q,f as R,Gn as S,yn as T,vn as U,Cn as V,En as W,xn as X,pn as Y,Ae as Z,Yt as _,zn as a,$n as a0,bn as a1,Dn as a2,be as a3,On as a4,Bn as a5,Q as a6,Mn as a7,An as a8,In as a9,Hn as aa,Pn as ab,kn as ac,un as ad,Me as ae,Sn as af,Oe as ag,Ne as b,Fn as c,de as d,U as e,R as f,Kn as g,se as h,Ue as i,Vn as j,y as k,Wn as l,w as m,Ce as n,jn as o,Xt as p,Un as q,A as r,v as s,tn as t,Zn as u,en as v,Jn as w,Yn as x,Xn as y,Nn as z};
