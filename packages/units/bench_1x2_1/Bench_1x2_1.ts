...
import glbBase from './assets/bench_1x2_1.glb?url';
import BenchUnit, {
  type BenchUnitOptions
} from '@cuby-world/app/lib/classes/unit/Bench';

export type BenchOptions = BenchUnitOptions;
export default class Bench_1x2_1 extends BenchUnit<BenchOptions> {
  static override KEY = 'bench_1x2_1';
  static override NAME = 'Bench 1x2 1';
