...
import DoorWallExtension from '../../../wallExtension/Door';
...
export default class DoorController extends ExtensionController<
  State,
  Observables
> {
  override extensionCheck(extension: WallExtension | null): boolean {
    return extension instanceof DoorWallExtension;
  }
}
