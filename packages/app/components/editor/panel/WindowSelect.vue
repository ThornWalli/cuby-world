...
import type { WindowWallExtensionItem } from '../../../lib/types/wall/extension/catalog';
...
): WallSelectItem<WindowWallExtensionItem> {
  return {
    item,
    preview: {
      type: $props.type,
...
const items = ref<WallSelectItem<WindowWallExtensionItem>[]>(
